    ...
    <div class="shop-section pt-5 pb-5">
        <div class="wrapper">
            <div class="row no-gutters">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 p-3"  v-for="(product, index) in expensive_products"
...
export default {
    ...
    async created() {
       await this.fetchExpensiveProducts();
    },
    computed: {
        ...mapState("home", ["expensive_products"])
    },
    methods: {
        ...mapActions("home", {
